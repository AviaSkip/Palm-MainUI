...
local TweenColourDown = TweenService:Create(Button, TweenInfo.new(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(27, 27, 27)})
local TweenColourUp = TweenService:Create(Button, TweenInfo.new(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(36, 36, 36)})
